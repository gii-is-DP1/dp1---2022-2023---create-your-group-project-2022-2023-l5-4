...
@Component
public class TournamentModeFormatter implements Formatter<GameMode> {
	...
	@Override
	public String print(GameMode tournamentMode, Locale locale) {
		return tournamentMode.getName();
	}

	@Override
	public GameMode parse(String text, Locale locale) throws ParseException {
		Iterable<GameMode> tournamentModes = this.tournamentService.findGameModes();
		for (GameMode tournamentmode : tournamentModes) {
