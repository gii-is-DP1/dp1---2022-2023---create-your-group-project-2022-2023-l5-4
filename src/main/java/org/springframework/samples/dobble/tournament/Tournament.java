...
public class Tournament extends BaseEntity {
    ...
    @JoinTable(name = "tournamentmodetournament", joinColumns = @JoinColumn(name = "tournamentId", nullable = false, table = "tournaments"), inverseJoinColumns = @JoinColumn(name = "tournamentModeId", nullable = false, table = "tournamentModes"))
	private List<TournamentMode> tournamentmodes;
